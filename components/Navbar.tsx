    ...
    <header className="w-full font-sans bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="container mx-auto px-6 h-20 flex justify-between items-center relative bg-white z-50">
        ...
        <nav className="hidden md:flex items-center gap-8 text-xs font-bold tracking-widest text-gray-600 uppercase">
          <a href="#home" className="hover:text-brand-secondary transition-colors">Home</a>
          <a href="#services" className="hover:text-brand-secondary transition-colors">Services</a>
          <a href="#why-us" className="hover:text-brand-secondary transition-colors">Why Us</a>
        ...
        <div className="hidden md:flex items-center gap-4">
           ...
           <a href="#contact" className="bg-brand-green text-white text-xs font-bold px-6 py-3 rounded hover:bg-opacity-90 transition-colors uppercase tracking-wider">
             Contact Us
           </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 py-4 px-6 flex flex-col gap-4 shadow-xl absolute top-full left-0 w-full z-40">
          ...
          <a href="#contact" onClick={() => setIsOpen(false)} className="block w-full text-center py-3 bg-brand-green text-white font-bold text-xs uppercase tracking-widest">Contact</a>
        </div>
      )}
    </header>
  );
